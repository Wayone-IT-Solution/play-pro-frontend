        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Your privacy is important to us. Learn how Play Pro protects and handles your data.
            </p>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-6 text-gray-700 leading-relaxed">
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p className="mb-3">When you use Play Pro, we may collect the following personal information:</p>
                <ul className="space-y-2 ml-4">
                  <li className="flex items-start">
                    <span className="w-2 h-2 rounded-full mt-2 mr-3" style={{ backgroundColor: '#013F5E' }}></span>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                ...
                <p>We automatically collect information about how you use our app, including:</p>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-blue-50 p-4 rounded-lg border-l-4" style={{ borderColor: '#013F5E' }}>
                  ...
                  <p className="text-sm">Provide and maintain our field booking services, process payments, and manage your account.</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border-l-4" style={{ borderColor: '#013F5E' }}>
                  <h4 className="font-semibold text-gray-900 mb-2">Communication</h4>
                  <p className="text-sm">Send you booking confirmations, updates, and customer support messages.</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border-l-4" style={{ borderColor: '#013F5E' }}>
                  <h4 className="font-semibold text-gray-900 mb-2">Improvement</h4>
                  <p className="text-sm">Analyze usage patterns to improve our app features and user experience.</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg border-l-4" style={{ borderColor: '#013F5E' }}>
                  <h4 className="font-semibold text-gray-900 mb-2">Marketing</h4>
                  <p className="text-sm">Send promotional offers and updates about new features (with your consent).</p>
                </div>
              </div>
            </div>
          </section>
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 p-6 rounded-xl">
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm">Limited access to personal data on a need-to-know basis with strict authentication.</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 mx-auto mb-3 p-3 rounded-full" style={{ backgroundColor: '#013F5E' }}>
                      <Database className="w-6 h-6 text-white" />
                    ...
                    <p className="text-sm">Data stored in secure, regularly monitored servers with backup and recovery systems.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="space-y-2 text-gray-700">
                <p><strong>Email:</strong> privacy@footballplaypro.com</p>
                <p><strong>Phone:</strong> +1 (555) 123-4567</p>
                <p><strong>Address:</strong> 123 Sports Avenue, Field City, FC 12345</p>
              </div>
            </div>
          </section>
