        ...
        <div className="relative mt-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="text-center">
            ...
            <p className="text-xl sm:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
              Fair and transparent refund guidelines for all Play Pro bookings
              and services.
            </p>
      ...
      <div className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            ...
            <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Contact our support team through the app or email with
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      We'll review your request within 24-48 hours and verify
                      eligibility.
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Approved refunds are processed within 3-5 business days to
              ...
              >
                <p className="text-sm font-medium text-gray-800">
                  ...
                  your account within 3-5 business days, though it may take up
                  to 10 business days depending on your bank or payment
                  provider.
                </p>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="text-sm text-gray-700 space-y-1">
                      ...
                      <li>
                        • Last-minute cancellations due to personal reasons
                      </li>
                    </ul>
                  </div>
                  <div>
              ...
              <div className="bg-orange-50 p-4 rounded-lg border-l-4 border-orange-400">
                <p className="text-sm">
                  <strong>Special Circumstances:</strong> We may consider
                  refunds for exceptional situations on a case-by-case basis.
            ...
            <div className="space-y-6">
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                <p className="text-sm text-gray-700">
                  <strong>Important:</strong> Refunds will be processed to the
                  same payment method used for the original transaction. If the
                  original payment method is no longer available, please contact
                  our support team for alternative arrangements.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              <p>
                If you're not satisfied with our refund decision, we encourage
                you to contact our customer service team to discuss your
                concerns. We're committed to finding fair solutions for all our
                users.
              </p>
              <div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    1. <strong>First Contact:</strong> Reach out to our standard
                    support team
                  </p>
                  <p>
                    2. <strong>Escalation:</strong> Request escalation to a
                    senior support manager
                  </p>
                  <p>
                    3. <strong>Final Review:</strong> Management review for
                    complex cases
                  </p>
                  <p>
                    4. <strong>External Mediation:</strong> Third-party
                    mediation if internal resolution fails
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              <p className="text-gray-700 mb-4">
                ...
                changes in our services or legal requirements. When we make
                changes, we will:
              </p>
          ...
          <section>
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-700 text-center mb-6">
                Contact our dedicated refund support team for quick assistance
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-sm">
                  ...
                  <div className="space-y-2 text-gray-700 text-sm">
                    <p>
                      <strong>Email:</strong> refunds@footballplaypro.com
                    </p>
                    <p>
                      <strong>Phone:</strong> +1 (555) REFUND-1
                    </p>
                    <p>
                      <strong>Live Chat:</strong> Available in the app 24/7
                    </p>
                  </div>
                </div>
