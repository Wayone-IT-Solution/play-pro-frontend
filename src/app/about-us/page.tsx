      ...
      <div className="flex justify-center items-center bg-white p-20">
        <div className="flex w-full justify-between gap-20">
          ...
          <div className="flex flex-col w-2/5 justify-start">
            <p className="text-[#A21B3C] tracking-widest mb-2">A BIT</p>
            <h2 className="text-5xl font-extrabold text-[#0B0B0B] mb-4">
              ABOUT US
            </h2>
            <p className="text-[#4A4A4A] text-lg mb-8 font-light">
            ...
            <button
              ...
              className="text-white w-fit px-6 py-4 rounded-3xl text-lg"
            >
              EXPLORE MORE
            </button>
          </div>
          ...
          {/* Right Image div */}
          <div className="relative w-3/5 flex flex-col gap-4">
            {/* Top Large Image */}
            <div className="relative rounded-[12.87px] overflow-hidden h-[220px]">
              <Image
                src="/assets/sky.png"
                alt="Top Stadium"
                fill
            ...
            {/* Middle Large Image */}
            <div className="relative mb-10 rounded-[12.87px] h-[320px]">
              <Image
                src="/assets/sky2.png"
                alt="Middle Stadium"
                fill
              ...
              <div className="absolute z-10 -bottom-[116px] -left-16 rounded-[12.87px] overflow-hidden">
                <Image
                  src="/assets/sky3.png"
                  alt="Soccer"
                  width={500}
              ...
              {/* 10+ Places Tag */}
              <div className="absolute z-50 -bottom-20 left-[230px] p-6 bg-[#013F5E] rounded-2xl flex flex-col justify-center items-center text-white font-bold text-3xl">
                <span className="text-5xl">10+</span>
                <span className="text-3xl font-medium">Places</span>
              </div>
            </div>
          </div>
        </div>
