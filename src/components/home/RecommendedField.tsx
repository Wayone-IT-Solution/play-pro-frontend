          ...
          <div>
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2 flex items-center gap-2">
              <Image
                ...
                alt={getLocalizedText("Cricket Icon", "أيقونة الكريكيت")}
                width={32}
                height={32}
                className="inline-block"
              />
              {getLocalizedText("Cricket Fields", "ملاعب الكريكيت")}
            </h2>
            <p className="text-gray-600 text-base sm:text-lg">
              {getLocalizedText(
                "Find and book the best cricket fields near you quickly and easily.",
                "اعثر على أفضل ملاعب الكريكيت بالقرب منك واحجزها بسرعة وسهولة."
              )}
            </p>
          </div>
