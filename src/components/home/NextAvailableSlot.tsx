          ...
          <div>
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-900 mb-2 flex items-center gap-2">
              <Image
                ...
                alt={getLocalizedText("Football Icon", "أيقونة كرة القدم")}
                width={32}
                height={32}
                className="inline-block"
              />
              {getLocalizedText("Football Fields", "ملاعب كرة القدم")}
            </h2>
            <p className="text-gray-600 text-base sm:text-lg">
              {getLocalizedText(
                "Discover the next available football fields near you and book instantly!",
                "اكتشف الملاعب المتاحة لكرة القدم بالقرب منك واحجزها فوراً!"
              )}
            </p>
          </div>
